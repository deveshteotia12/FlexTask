...
class SidebarContent extends Component {
  ...
  render() {
    ...
    if (localStorage.getItem("userData")) {
      const obj1 = JSON.parse(localStorage.getItem("userData"));
      username = obj1?.role;
    }
    return (
      <React.Fragment>
            ...
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                <Link to="/employee" className="waves-effect">
                  ...
                  <span className="ml-1">{this.props.t("Employee")}</span>
                </Link>
              </li>
              <li>
                <Link to="/onboarding-employee" className="waves-effect">
                  <i className="fas fa-user-plus"></i>
                  <span className="ml-1">{this.props.t("Onboarding Employee")}</span>
                </Link>
              </li>
              <li>
                <Link to="/client" className="waves-effect">
                  <i className="fas fa-user-tie"></i>
                  <span className="ml-1">{this.props.t("Client")}</span>
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/timesheet-approval" className="waves-effect">
                  <i className="fas fa-clock"></i>
                  <span className="ml-1">{this.props.t("Timesheet")}</span>
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/event" className="waves-effect">
                  <i className="fas fa-calendar-day"></i>
                  <span className="ml-1">{this.props.t("Event")}</span>
                </Link>
              </li>
              <li>
                <Link to="/holiday" className="waves-effect">
                  <i className="fas fa-walking"></i>
                  <span className="ml-1">{this.props.t("Holiday")}</span>
                </Link>
              </li>
              <li>
                <Link to="/leave" className="waves-effect">
                  <i className="fas fa-sign-out-alt"></i>
                  <span className="ml-1">{this.props.t("Leave Management")}</span>
                </Link>
              </li>
              <li>
                <li>
                  <Link to="/payroll" className="waves-effect">
                    <i className="fa fa-money	"></i>
                    <span className="ml-1">{this.props.t("Payroll")}</span>
                  </Link>
                </li>
              </li>
            </ul>
        ...
        {username === "employee" && (
          <div id="sidebar-menu">
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              {/* <li>
                <Link to="/client-view" className="waves-effect">
                  <i className="fas fa-user-tie"></i>
                  <span className="ml-1">{this.props.t("Client")}</span>
                </Link>
              </li>
              <li>
                <Link to="/project-view" className="waves-effect">
                  <i className="fas fa-tasks"></i>
                  <span className="ml-1">{this.props.t("Project")}</span>
                </Link>
              </li> */}
        ...
        {username == "admin" && (
          <div id="sidebar-menu">
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              {/* <li>
                <Link to="/hr" className="waves-effect">
                  <i className="ri-account-circle-line"></i>
                  <span className="ml-1">{this.props.t("HR")}</span>
                </Link>
              </li> */}
              <li>
                <Link to="/employee" className="waves-effect">
              ...
              <li>
                <Link to="/holiday" className="waves-effect">
                  <i className="fas fa-walking"></i>
                  <span className="ml-1">{this.props.t("Holidays")}</span>
                </Link>
              </li>
              <li>
                <Link to="/leave-request" className="waves-effect">
                  <i className="fas fa-sign-out-alt"></i>
                  <span className="ml-1">
                    {this.props.t("Leave Management")}
                  </span>
                </Link>
              </li>
              {/* <li>
               ...
               */}
                {/* <li>
                  <Link to="/bulk-payslip-upload" className="waves-effect">
                    <i className="fa fa-money	"></i>
                    <span className="ml-1">{this.props.t("Bulk Payslip")}</span>
                  </Link>
                </li> */}

                <li>
                  <Link to="/consolidated-report" className="waves-effect">
                    <i className="fas fa-tasks	"></i>
                    <span className="ml-1">{this.props.t("Consolidated Report")}</span>
                  </Link>
                </li>
                {/* <li>
                  <Link to="/consolidated-timesheet" className="waves-effect">
                    <i className="fas fa-tasks	"></i>
                    <span className="ml-1">{this.props.t("Consolidated Timesheet")}</span>
                  </Link>
                </li>
               */}
